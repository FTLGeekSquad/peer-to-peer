...
function EquipmentGrid({}) {
  ...
  useEffect(() => {
    ...
    if (selectedEquipment && userData.userId) {
      ...
      axios.get(`http://localhost:3000/reviews/${selectedEquipment.listingId}/rating/${userData.userId}`)
  ...
  const handleRatingSubmit = async () => {
    ...
    try {
      if (userRating !== null) {
        ...
        await axios.put(`http://localhost:3000/reviews/${selectedEquipment.listingId}/rating/${userData.userId}`, {
      ...
      {selectedEquipment && (
        ...
        >
          ...
          <div className="rating">
            ...
            <span className="rating-number">{selectedEquipment.avgRating.toFixed(1)}</span>
          </div>
          {isLoggedIn && (
